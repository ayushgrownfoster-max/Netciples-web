                      ...
                      >
                        ...
                        <div className="tw:relative tw:py-3">
                          <textarea
                            ...
                            className="tw:w-full tw:bg-[#F5F5F5] tw:placeholder:text-[#767676] tw:border-0 tw:text-[14px] tw:p-3 tw:rounded-xl tw:outline-none tw:resize-none"
                          />
                          <span className="tw:absolute tw:bottom-5 tw:right-2 tw:text-[12px] tw:text-[#767676]">
